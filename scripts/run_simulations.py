...
CASES = {
    "homogeneous": {"problem": HomogeneousProblem, "label": "Homogeneous"},
    "tracerconservation": {"problem": TracerConservationProblem, "label": "Tracer Conservation"},
    "tracerdecay": {"problem": TracerDecayProblem, "label": "Tracer Decay"},
}


def ratbrain_diffusion(
    meshfile,
    results_path,
    model,
    timestep,
    endtime,
    computer=None,
    center=PARAMS["injection_center"],
    ...
    projectors.rescale_function(u0, 1.0)  # Scale to unit mass total
